...
import com.demoapp.actuator.health.GreetingHealthIndicator;
...
public class GreetingController extends BaseController
{
    ...
    @Autowired
    GreetingHealthIndicator greetingsHealthIndicator;
    ...
    public ResponseEntity<Health> getHealth() 
    {
        ...
        Health health = greetingsHealthIndicator.health();
